...
class PassionTechHome(Home):
    ...
    @http.route(
        [
            "/odoo/dashboards",
            "/odoo/dashboards/<path:subpath>",
        ],
        type="http",
        auth="none",
        readonly=Home._web_client_readonly,
    )
    def passiontech_dashboards(
        self,
        subpath=None,
        s_action=None,
        **kw,
    ...
    @http.route(
        [
            "/odoo/to-do",
            "/odoo/to-do/<path:subpath>",
        ],
        type="http",
        auth="none",
        readonly=Home._web_client_readonly,
    )
    def passiontech_todo(
        self,
        subpath=None,
        s_action=None,
        **kw,
    ...
    @http.route(
        [
            "/odoo/employees",
            "/odoo/employees/<path:subpath>",
        ],
        type="http",
        auth="none",
        readonly=Home._web_client_readonly,
    )
    def passiontech_employees(
        self,
        subpath=None,
        s_action=None,
        **kw,
    ...
    @http.route(
        [
            "/odoo/contacts",
            "/odoo/contacts/<path:subpath>",
        ],
        type="http",
        auth="none",
        readonly=Home._web_client_readonly,
    )
    def passiontech_contacts(
        self,
        subpath=None,
        s_action=None,
        **kw,
    ...
    @http.route(
        [
            "/odoo/calendar",
            "/odoo/calendar/<path:subpath>",
        ],
        type="http",
        auth="none",
        readonly=Home._web_client_readonly,
    )
    def passiontech_calendar(
        self,
        subpath=None,
        s_action=None,
        **kw,
